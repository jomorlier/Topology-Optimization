...
% April 2017
function x = topmna(x,nelx,nely,volfrac,penal0,tol,tolchange)
...
while (nodesMerged) 
  %% START ITERATION
  dtmin = 0;
  dtmax = min([x(4:5:end);x(5:5:end)]); %min des largeurs/longueurs
  x = constraint(x,mMax);
